...
public class FormlessSwordWheel : ModItem
{
    ...
    public override void AddRecipes()
    {
        CreateRecipe()
            ...
            .AddIngredient<global::XianXia.Content.Items.Materials.LowGradeSpiritStone>(12)
            .AddTile(ModContent.TileType<global::XianXia.Content.Tiles.Stations.SectTrialAltarTile>())
            .Register();
    }
...
public class QiGatheringPendant : ModItem
{
    ...
    {
        CreateRecipe()
            .AddIngredient<global::XianXia.Content.Items.Materials.GreenwoodRoot>(5)
...
public class FurnaceHeartRing : ModItem
{
    ...
    {
        CreateRecipe()
            .AddIngredient<global::XianXia.Content.Items.Materials.FurnaceSlagIron>(5)
            .AddIngredient<global::XianXia.Content.Items.Materials.LowGradeSpiritStone>(8)
            .AddTile(ModContent.TileType<global::XianXia.Content.Tiles.Stations.ArtifactForgeTile>())
            .Register();
    }
...
public class LightningWardJade : ModItem
{
    ...
    {
        CreateRecipe()
            .AddIngredient<global::XianXia.Content.Items.Materials.TribulationCloudDew>(5)
            .AddIngredient<global::XianXia.Content.Items.Materials.LowGradeSpiritStone>(8)
            .AddTile(ModContent.TileType<global::XianXia.Content.Tiles.Stations.ArtifactForgeTile>())
            .Register();
    }
...
public class NascentSoulJadeBox : ModItem
{
    ...
    {
        CreateRecipe()
            .AddIngredient<global::XianXia.Content.Items.Materials.SectTrialToken>(5)
            .AddIngredient<global::XianXia.Content.Items.Materials.LowGradeSpiritStone>(8)
            .AddTile(ModContent.TileType<global::XianXia.Content.Tiles.Stations.ArtifactForgeTile>())
            .Register();
    }
