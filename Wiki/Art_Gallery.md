...
| <img src="../Content/Items/HandGenerated/FoundationSeal.png" alt="Foundation Seal" width="48"> | Foundation Seal | `item icon` | 24x24 | - | Hand Generated Item 资源：透明背景、强轮廓、有限色板，遵循 ART_ASSET_GENERATION_PLAN.md。 | `Content/Items/HandGenerated/FoundationSeal.png` |
...
| <img src="../Content/Items/HandGenerated/HeavenTabletSeal.png" alt="Heaven Tablet Seal" width="48"> | Heaven Tablet Seal | `item icon` | 24x24 | - | Hand Generated Item 资源：透明背景、强轮廓、有限色板，遵循 ART_ASSET_GENERATION_PLAN.md。 | `Content/Items/HandGenerated/HeavenTabletSeal.png` |
...
| <img src="../Content/Items/HandGenerated/ImperialDecreeItem.png" alt="Imperial Decree Item" width="48"> | Imperial Decree Item | `item icon` | 24x24 | - | Hand Generated Item 资源：透明背景、强轮廓、有限色板，遵循 ART_ASSET_GENERATION_PLAN.md。 | `Content/Items/HandGenerated/ImperialDecreeItem.png` |
...
| <img src="../Content/Items/HandGenerated/MedicineKingWoodHeart.png" alt="Medicine King Wood Heart" width="48"> | Medicine King Wood Heart | `item icon` | 24x24 | - | Hand Generated Item 资源：透明背景、强轮廓、有限色板，遵循 ART_ASSET_GENERATION_PLAN.md。 | `Content/Items/HandGenerated/MedicineKingWoodHeart.png` |
...
| <img src="../Content/Items/HandGenerated/RouteMaterial.png" alt="Route Material" width="48"> | Route Material | `item icon` | 24x24 | - | Hand Generated Item 资源：透明背景、强轮廓、有限色板，遵循 ART_ASSET_GENERATION_PLAN.md。 | `Content/Items/HandGenerated/RouteMaterial.png` |
...
| <img src="../Content/Items/HandGenerated/StarCalamityCore.png" alt="Star Calamity Core" width="48"> | Star Calamity Core | `item icon` | 24x24 | - | Hand Generated Item 资源：透明背景、强轮廓、有限色板，遵循 ART_ASSET_GENERATION_PLAN.md。 | `Content/Items/HandGenerated/StarCalamityCore.png` |
