...
| 中型武器 | 56x56 到 104x104 | 飞剑、符器、弩机 | 按等级梯度递增，默认左下到右上朝向 |
| 投射物 | 16x16 到 96x96，光束型更长 | 灵弹、剑气、符火、雷光 | 明确运动方向和碰撞核心；大型 AoE 场约 96x96，光束型可达 32x256 |
| 小敌怪 | 40x40 到 56x56 | 史莱姆、虫、蝠 | 至少 idle、move、hit |
| 中敌怪 | 64x64 到 80x88 | 傀儡、修士、飞行怪 | 常见尺寸 64×64 至 72×88，动画帧尺寸固定 |
| Boss 主体 | 120x40 到 208x208 | Boss 基础 sprite | 大型或分段 Boss 可拆部件；蠕虫型体段约 120x40，终局约 208x208 |
| Boss 头像 | 32x32 或 40x40 | 地图/UI 头像 | 只保留头部核心剪影；终局大型 Boss 头像用 40x40 |
