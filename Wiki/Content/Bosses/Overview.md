...
> 🔗 **分段 Boss 说明：** Spirit Vein Wyrm、Thunder Marsh Jiao 和 Shattered Jade Wyrm Minion 是**蠕虫型 Boss**，由 head / body / tail 多段独立精灵拼接而成（参照 Eater of Worlds 架构）。每段有独立尺寸和素材文件。
...
| [雷泽蛟](Entries/Thunder_Marsh_Jiao.md) | <img src="../../../Assets/Final/thunder_marsh_jiao/thunder_marsh_jiao__head__v01.png" width="64"> | Hardmode | ✅ head+body+tail（12-16 节） | 空中蛇形盘旋 + 俯冲 | 雷泽云层事件 | 雷系武器、劫云露 |
| [星渊胎主](Entries/Abyssal_Star_Womb.md) | <img src="../../../Assets/Final/abyssal_star_womb/abyssal_star_womb__body__v01.png" width="64"> | Hardmode | 单体 | 空中漂浮 | 星渊裂隙污染值达到阈值 | 星蚀晶、禁术材料 |
| [无相剑魄](Entries/Formless_Sword_Soul.md) | <img src="../../../Assets/Final/formless_sword_soul/formless_sword_soul__body__v01.png" width="64"> | Post-Plantera | 单体 | 空中悬浮 + 瞬移 | 万宗遗址剑碑试炼 | 飞剑升级材料 |
| [青木药王残影](Entries/Greenwood_Medicine_King_Echo.md) | <img src="../../../Assets/Final/greenwood_medicine_king_echo/greenwood_medicine_king_echo__body__v01.png" width="64"> | Post-Plantera | 单体 | 地面 + 阵法 | 完成药宗残卷链 | 高阶丹炉 |
| [天碑守御](Entries/Heaven_Tablet_Guardian.md) | <img src="../../../Assets/Final/heaven_tablet_guardian/heaven_tablet_guardian__body__v01.png" width="64"> | Post-Golem | 单体 | 地面重装 + 飞行 | 坠天宫阙激活天碑 | 天道碎片 |
| [残天监察使](Entries/Broken_Heaven_Inspector.md) | <img src="../../../Assets/Final/broken_heaven_inspector/broken_heaven_inspector__body__v01.png" width="64"> | Post-Golem | 单体 | 空中巡弋 | 化神境后挑战 | 天庭法旨、化神材料 |
| [月骸仙君](Entries/Moonbone_Immortal.md) | <img src="../../../Assets/Final/moonbone_immortal/moonbone_immortal__body__v01.png" width="64"> | Post-Moon Lord | 单体 | 空中 + 传送 | 月骸天渊核心召唤 | 月骸材料、终局钥匙 |
| [旧天道核心](Entries/Old_Heaven_Dao_Core.md) | <img src="../../../Assets/Final/old_heaven_dao_core/old_heaven_dao_core__body__v01.png" width="64"> | Endgame | 单体 | 静态 + 模块旋转 | 完成三条路线选择前置 | 斩道奖励 |
