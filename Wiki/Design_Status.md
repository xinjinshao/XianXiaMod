...
| 玩家系统 | 已完成 | 灵气、最大灵气、灵压、修行境界、境界属性加成、逐阶突破、保存与基础同步 |
| UI | 已完成 | 灵气条 UI 与贴图 |
...
| 宗门进度 | 已推进 | Boss 击败转化为宗门声望，并影响经阁卷灵与坠天使者商店；宗门玉简可提示下一步目标 |
| 敌怪/Boss | 已推进 | 浅层灵脉敌怪、灵脉蠕虫阶段 AI、生成敌怪、Boss、掉落、召唤物、召唤配方、境界门槛、召唤物 Tooltip、召唤失败提示、通用阶段 AI、阶段提示和 Bestiary 文本 |
| 友好 NPC | 已推进 | 药宗学徒、游方炼器师、观劫客、经阁卷灵、坠天使者、进度商店、宗门玉简、状态对话、Bestiary 风味文本和幸福度生态偏好 |
| 本地化 | 已推进 | 生成内容、手写站点、Bestiary、进度提示、配置项的中英文显示名与说明 |
