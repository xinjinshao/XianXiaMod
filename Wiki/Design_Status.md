...
| 敌怪/Boss | 已推进 | 浅层灵脉敌怪、灵脉蠕虫阶段 AI、生成敌怪、生成敌怪主题行为、Boss、掉落、召唤物、召唤配方、境界门槛、前置 Boss 门槛、召唤物 Tooltip、召唤失败提示、通用阶段 AI、阶段提示、主题阶段弹幕和 Bestiary 文本 |
...
- 继续深化高阶 Boss 专属机制、召唤物行为和场地互动；生成武器投射物与生成敌怪已接入第一批主题行为。
