...
| 物品 | 已推进 | 生成材料、丹药、饰品、法器、召唤物、基础配方、炼丹配方、炼器升级配方、丹药灵压管理、法器代价差异和法器觉醒 |
| 制作站 | 已推进 | 炼丹炉、器胚炉、丹药配方迁移、法器配方迁移与站点附近加成 |
| Buff/Debuff | 已推进 | 聚气、回春、抗劫、灵压紊乱、丹炉温养、器胚共鸣 |
| 天劫 | 已推进 | 突破后触发短时天劫事件，包含劫压、观劫盘、落雷预警线、抗劫缓解、丹药降压、开始/完成提示、完成奖励与首次渡劫感悟 |
| 修行进度 | 已推进 | 引气、凝气、筑基、金丹、元婴、斩灵、渡劫、斩道的突破链路；突破物品会校验境界并避免误消耗 |
| 宗门进度 | 已推进 | Boss 击败转化为宗门声望，并影响经阁卷灵与坠天使者商店；宗门玉简可显示声望、下一步目标和待领取委托；友好 NPC 可发放一次性宗门委托奖励 |
| 敌怪/Boss | 已推进 | 浅层灵脉敌怪、灵脉蠕虫阶段 AI、生成敌怪、Boss、掉落、召唤物、召唤配方、境界门槛、前置 Boss 门槛、召唤物 Tooltip、召唤失败提示、通用阶段 AI、阶段提示、主题阶段弹幕和 Bestiary 文本 |
| 友好 NPC | 已推进 | 药宗学徒、游方炼器师、观劫客、经阁卷灵、坠天使者、进度商店、宗门委托、宗门玉简、状态对话、Bestiary 风味文本和幸福度生态偏好 |
...
- 继续深化高阶 Boss 专属机制、召唤物行为和场地互动。
- 扩展友好 NPC 的多步骤任务线、住宅偏好和更细的委托条件；宗门玉简已能提示当前待领取委托。
- 将更多 Wiki 参数映射到 C# 字段、配方、掉落表和进度门槛；生成 Boss 召唤物已校验境界与前置试炼。
- 添加更细的天劫事件和宗门任务链；高阶炼器觉醒机制与首次渡劫感悟已接入第一版。
